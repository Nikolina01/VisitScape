...
public class Pula extends AppCompatActivity {
    ImageView second_back_arrow, second_arrow_up;

    TextView second_title3, second_subtitle3, more_details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        second_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Pula.this, Activity2.class);
        ...
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Pula.this, FifthActivity.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(second_arrow_up, "background_image_transition3");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Pula.this, pairs);
