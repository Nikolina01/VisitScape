...
public class Vinkovci extends AppCompatActivity {
    ImageView second_back_arrow, second_arrow_up;

    TextView second_title5, second_subtitle5, more_details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vinkovci);
        ...
        second_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Vinkovci.this, Activity2.class);
        ...
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Vinkovci.this, SeventhActivity.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(second_arrow_up, "background_image_transition5");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Vinkovci.this, pairs);
